...
-- Q1
SELECT C.CUSTOMER_ID, C.NAME FROM CUSTOMER C, ENROLL_CUSTOMER EC, LOYALTY_PROGRAM LP WHERE LP.BRAND_ID = 'B01' and LP.CODE = EC.LP_CODE and EC.CUSTOMER_ID <> C.CUSTOMER_ID;
-- Q3
...
-- Q
SELECT LP_CODE, -1*SUM(POINTS) FROM WALLET WHERE CATEGORY = 'REDEEM' GROUP BY LP_CODE;